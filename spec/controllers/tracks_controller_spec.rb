  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved track as @track" do
        ...
        post :create, {:track => { "artist" => "invalid value" }}, valid_session
        assigns(:track).should be_a_new(Track)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested track" do
        ...
        Track.any_instance.should_receive(:update).with({ "artist" => "MyString" })
        put :update, {:id => track.to_param, :track => { "artist" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the track as @track" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Track.any_instance.stub(:save).and_return(false)
        put :update, {:id => track.to_param, :track => { "artist" => "invalid value" }}, valid_session
        assigns(:track).should eq(track)
      end
